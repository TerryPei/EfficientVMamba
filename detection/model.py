...
@MODELS_MMSEG.register_module()
@MODELS_MMDET.register_module()
class MM_EfficientVSSM(BaseModule, Backbone_EfficientVSSM):
    def __init__(self, *args, **kwargs):
        BaseModule.__init__(self)
        Backbone_EfficientVSSM.__init__(self, *args, **kwargs)
...
if __name__ == "__main__":
    ...
    mmseg_flops(f"{mmdet_path}/configs/vssm/mask_rcnn_vssm_fpn_coco_efficient.py")
...
#     # mmseg_flops(f"{mmseg_path}/configs/vssm/upernet_vssm_4xb4-160k_ade20k-512x512_base.py") # Flops: 1225941913504.0  Params: 109765548
#     # mmseg_flops(f"{mmseg_path}/configs/vssm/upernet_vssm_4xb4-160k_ade20k-640x640_small.py", input_shape=(3, 640, 2560)) # Flops: 1689017528400.0  Params: 76070924
#     # mmseg_flops(f"{mmseg_path}/configs/vssm/upernet_efficient_4xb4-160k_ade20k-512x512_tiny.py")
#     # mmseg_flops(f"{mmseg_path}/configs/vssm/upernet_efficient_4xb4-160k_ade20k-512x512_2.py")
#     # mmseg_flops(f"{mmseg_path}/configs/vssm/upernet_efficient_4xb4-160k_ade20k-512x512_3.py")
